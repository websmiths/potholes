...
(async function () {
  ...
  // ---------- petition form ----------
  function setupPetitionForm(cfg) {
    ...
    form.addEventListener("submit", async (e) => {
      ...
      try {
        if (endpoint) {
          ...
          showOk("Thank you — your signature has been recorded.");
          form.reset();
        } else {
          ...
          showOk("Opening your email app to send your signature…");
        }
      } catch (err) {
